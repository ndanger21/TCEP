...
target_framework=$2
workers+=($manager)
#workers=("10.2.1.40" "10.2.1.92" "10.2.1.72" "10.2.1.74" "10.2.1.84" "10.0.30.15")
workers=("10.2.1.40" "10.2.1.84" "10.2.1.92" "10.0.30.15")
...
copy_files() {
  ...
  do
    ...
    scp ../yahoo_geni_5s_combined_samples.csv ${user}@${i}:~/automl/
  done
